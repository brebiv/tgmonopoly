...
class Command(BaseCommand):
    ...
    def populate(self):
        ...
        with transaction.atomic():
            ...
            Property.objects.create(board_config=board_config, position=14, name="T-Mobile", price=160, mortgage_value=80, house_price=100, rent=12, rent_with_1_house=60, rent_with_2_houses=180, rent_with_3_houses=500, rent_with_4_houses=700, rent_with_5_houses=900, group=comm, icon="/media/properties/tmobile_logo.svg")
