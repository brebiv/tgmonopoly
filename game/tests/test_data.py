...
TG_INIT_DATA_RAW_LIST = [_TG_INIT_DATA_1, _TG_INIT_DATA_2]
TG_INIT_DATA_PARSED = [
    parse_qs(init_data_raw) for init_data_raw in TG_INIT_DATA_RAW_LIST
]
TG_INIT_DATA_USER = [json.loads(data["user"][0]) for data in TG_INIT_DATA_PARSED]


def create_telegram_users(limit: int = 10) -> list[TelegramUser]:
    users = []
